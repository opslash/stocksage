...
def test_valuation_defaults_use_valid_company_statistics():
    ...
    assert defaults["low_shares_growth"] > defaults["mid_shares_growth"] > defaults["high_shares_growth"]
    assert defaults["low_discount_rate"] > defaults["mid_discount_rate"] > defaults["high_discount_rate"]
